        ...
        <div class="col-lg-6">
          <div class="card ">
            <div class="card-header">
              <h3 class="text-center title-2">New Facility Form</h3>
              @if (Session::has('pharmacy_msg'))
              {!! session('pharmacy_msg') !!}
              @endif
            </div>
            <div class="card-body">
              <form action="/facility/save" method="POST">
                @csrf
                <div class="form-group">
                  <label for="mflcode" class="control-label mb-1">Mflcode</label>
                  <div class="input-group">
                    <input id="mflcode" name="mflcode" type="text" class="form-control" value="" required />
                  </div>
                </div>
                <div class="form-group">
                ...
                <div>
                  <button type="submit" class="btn btn-lg btn-dark btn-block">
                    <i class="fa fa-save fa-lg"></i> Save Facility
                  </button>
                </div>
              </form>
            </div>
