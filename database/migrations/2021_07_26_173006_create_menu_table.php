    ...
    public function up()
    {
        ...
        DB::table('tbl_menu')->insert(
            array(
                ...
                ['name' => 'PMTCT', 'link' => '/dashboard/pmtct', 'menu_group_id' => '1', 'created_at' => now()],
                ['name' => 'PMTCT EID & PMTCT HEI POS  & HCA', 'link' => '/dashboard/pmtct-eid-hei-pos-hca', 'menu_group_id' => '1', 'created_at' => now()],
